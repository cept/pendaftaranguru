    ...
    <x-slot:title>{{ $title = 'Data Alternatif Calon Guru'; }}</x-slot:title>
      ...
      <div class="card">
        <div class="card-header">
            <h3 class="card-title">Edit Data Alternatif Calon Guru</h3>
          </div>
          <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group mb-3">
                            ...
                            <input list="pendaftarList" id="id_pendaftar" name="id_pendaftar" class="form-control @error('id_pendaftar') is-invalid @enderror" value="{{ old('id_pendaftar', $alternatif->id_pendaftar) }}" readonly>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group mb-3">
                            ...
                            <option value="0" {{ old('usia', $alternatif->usia) == '0' ? 'selected' : '' }}>< 30 tahun</option>
                            <option value="0.25" {{ old('usia', $alternatif->usia) == '0.25' ? 'selected' : '' }}>30-34 tahun</option>
                            <option value="0.75" {{ old('usia', $alternatif->usia) == '0.75' ? 'selected' : '' }}>35-40 tahun</option>
                            <option value="1" {{ old('usia', $alternatif->usia) == '1' ? 'selected' : '' }}>> 40 tahun</option>
                            </select>
