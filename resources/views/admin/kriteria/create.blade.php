        ...
        <form action="{{ route('kriteria.store') }}" method="post" enctype="multipart/form-data">
            ...
            <div class="col-md-4">
              <div class="form-group mb-3">
                  ...
                  <input type="number" class="form-control d-inline-block w-75 @error('pendidikan') is-invalid @enderror" name="pendidikan" value="{{ old('pendidikan') }}">
              ...
              <div class="form-group mb-3">
                  ...
                  <input type="number" class="form-control d-inline-block w-75 @error('ipk') is-invalid @enderror" name="ipk" value="{{ old('ipk') }}">
                  <span class="form-control d-inline-block text-center" style="width: 40px">%</span>
              ...
              <div class="form-group mb-3">
                  ...
                  <input type="number" class="form-control d-inline-block w-75 @error('pengalaman_kerja') is-invalid @enderror" name="pengalaman_kerja" value="{{ old('pengalaman_kerja') }}">
                  <span class="form-control d-inline-block text-center" style="width: 40px">%</span>
              ...
              <div class="form-group mb-3">
                  ...
                  <input type="number" class="form-control d-inline-block w-75 @error('usia') is-invalid @enderror" name="usia" value="{{ old('usia') }}">
                  <span class="form-control d-inline-block text-center" style="width: 40px">%</span>
